...
- {id: FRO_HF_DIV_clock.outFreq, value: 45 MHz}
- {id: FRO_HF_clock.outFreq, value: 45 MHz}
- {id: LPUART0_clock.outFreq, value: 45 MHz}
- {id: LPUART1_clock.outFreq, value: 45 MHz}
- {id: MAIN_clock.outFreq, value: 45 MHz}
- {id: Slow_clock.outFreq, value: 7.5 MHz}
- {id: System_clock.outFreq, value: 45 MHz}
- {id: TRACE_clock.outFreq, value: 45 MHz}
...
- {id: SCG.MDIV.scale, value: '0'}
- {id: SCG.NDIV.scale, value: '0'}
...
void BOARD_BootClockFROHF180M_InitClockModule(clock_module_t module)
{
    ...
    switch(module) {
        ...
        case kClockModule_DAC0Clk:
            ...
            CLOCK_SetClockDiv(kCLOCK_DivDAC0, 1U);         /* !< Set MRCC.DAC0_CLKDIV divider to value 1 */
            break;
        case kClockModule_FLEXCAN0Clk:
            CLOCK_AttachClk(kNONE_to_FLEXCAN0);            /* !< Switch FLEXCAN0 to  */
            break;
...
- {id: FRO_HF_clock.outFreq, value: 45 MHz}
- {id: MAIN_clock.outFreq, value: 45 MHz}
- {id: PLL1_DIV_clock.outFreq, value: 192 MHz}
- {id: PLL1_clock.outFreq, value: 192 MHz}
- {id: Slow_clock.outFreq, value: 7.5 MHz}
- {id: System_clock.outFreq, value: 45 MHz}
- {id: TRACE_clock.outFreq, value: 45 MHz}
- {id: UTICK0_clock.outFreq, value: 1 MHz}
...
void BOARD_BootClockPLL180M_InitClockModule(clock_module_t module)
{
    const pll_setup_t pll1Setup = {
        .pllctrl = SCG_SPLLCTRL_SOURCE(3U) | SCG_SPLLCTRL_SELI(19U) | SCG_SPLLCTRL_SELP(9U),
